...
class NoticeListViewWidget extends StatefulWidget {
  NoticeListViewWidget(
      {Key? key, required this.data, required this.widgetIndex})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return BackdropFilter(
      filter: ImageFilter.blur(
          sigmaX: checkNotice! ? 10.0 : 0, sigmaY: checkNotice! ? 10.0 : 0),
      child: ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            return Visibility(
              visible: checkNotice!,
              // ||
              //         widget.data[index].notification_status! ,
              // ? true
              // : false,
              child: Stack(
                children: [
